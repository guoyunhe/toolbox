...
export default function JsonFlattenPage() {
  ...
  const [deepParse, setDeepParse] = useLocalStorage('json_flatten_deep_parse', true);
  const [sortKeys, setSortKeys] = useLocalStorage('json_flatten_sort_keys', true);
